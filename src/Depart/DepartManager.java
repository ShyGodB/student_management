...
public class DepartManager extends JFrame {
	...
	Object[][] arrData = {};
	String[] arrField = { "院系编号", "院系名称", "院系介绍" };
	...
	private void init() throws Exception {
		...
		sql = "select * from department where isDel = false";
		// 刷新
		UpdateRecord();
	}
	...
	public void jButton5_actionPerformed(ActionEvent e) {
		...
		try {
			conn.getUpdate("update department set isDel = true where id = '" + Integer.valueOf(find) + "'");
