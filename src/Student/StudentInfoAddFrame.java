...
public class StudentInfoAddFrame extends JFrame {
	...
	private void init() throws Exception {
		...
		jButton1.addActionListener(new AddStudent(this));
		jButton1.setFont(new java.awt.Font("Dialog", Font.PLAIN, 16));

		jButton2.setText("退  出");
		jButton2.setBounds(new Rectangle(375, 324, 90, 27));
		jButton2.addActionListener(new QuitCurrentWindow(this));
	...
	public void addStudentInfo() {
		try {
			int res = conn.getUpdate("insert into student (realName, gender, birthday, nationality, nation, education, homeAddress, phone, homeTelephone, schoolTelephone) values ('"
			+ realName + "','" + gender + "','" + birthday + "','" + nationality + "','" + nation + "','" + education + "','" + homeAddress + "','" + phone + "','" + homeTelephone + "','" + schoolTelephone  + "')");
			if (res > 0) {
